...
import mx.tecnm.cdhidalgo.jaguarnews.databinding.FragmentGeneralBinding
...
class GeneralFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        baseDatos.collection("noticias").whereEqualTo("categoria", "general").get().addOnSuccessListener { documents ->
