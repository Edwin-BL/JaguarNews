...
import mx.tecnm.cdhidalgo.jaguarnews.databinding.FragmentMecatronicaBinding
...
class MecatronicaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        baseDatos.collection("noticias").whereEqualTo("categoria", "mecatronica").get()
