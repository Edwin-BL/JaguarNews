...
class FragmentAgregarUsuario : Fragment(R.layout.fragment_agregar_usuario) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        foto = view.findViewById(R.id.addFotoUser)
        name = view.findViewById(R.id.addName)
        lastName = view.findViewById(R.id.addLastName)
        mLastName = view.findViewById(R.id.addMLastName)
        email = view.findViewById(R.id.addEmail)
        pass = view.findViewById(R.id.addPass)

        rol = view.findViewById(R.id.addRolUsuario)

        val btnAgregar: MaterialButton = view.findViewById(R.id.btnAddUsuario)
                                        ...
                                        if (rolSeleccionado == "Administrador"){
                                                        ...
                                                        if (thisEmail.isNotEmpty() && thisPass.isNotEmpty()){
                                                            FirebaseAuth.getInstance().createUserWithEmailAndPassword(thisEmail, thisPass).addOnCompleteListener {
                                                                if (it.isSuccessful){
                                                                    ...
                                                                    findNavController().navigate(R.id.action_fragmentAgregarUsuario_to_nav_general)
                                            ...
                                            confirmaDialog.setPositiveButton("Confirmar"){ confirmaDialog, wich ->
                                                ...
                                                if (thisEmail.isNotEmpty() && thisPass.isNotEmpty()){
                                                    FirebaseAuth.getInstance().createUserWithEmailAndPassword(thisEmail, thisPass).addOnCompleteListener {
                                                        if (it.isSuccessful){
                                                            baseDatos.collection("users").document(thisEmail).set(
                                                                UsuarioDC!!)
                                                            findNavController().navigate(R.id.action_fragmentAgregarUsuario_to_nav_general)
                                                        }else{
                                                            showAlert()
