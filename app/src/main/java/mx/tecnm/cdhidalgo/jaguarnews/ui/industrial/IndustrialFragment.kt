...
import mx.tecnm.cdhidalgo.jaguarnews.databinding.FragmentIndustrialBinding
...
class IndustrialFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        baseDatos.collection("noticias").whereEqualTo("categoria", "industrial").get()
