...
import mx.tecnm.cdhidalgo.jaguarnews.databinding.FragmentBioquimicaBinding
...
class BioquimicaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        baseDatos.collection("noticias").whereEqualTo("categoria", "bioquimica").get().addOnSuccessListener { documents ->
