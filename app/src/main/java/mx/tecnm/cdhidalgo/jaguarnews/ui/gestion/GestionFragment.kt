...
import mx.tecnm.cdhidalgo.jaguarnews.databinding.FragmentGestionBinding
...
class GestionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        baseDatos.collection("noticias").whereEqualTo("categoria", "gestion").get().addOnSuccessListener { documents ->
